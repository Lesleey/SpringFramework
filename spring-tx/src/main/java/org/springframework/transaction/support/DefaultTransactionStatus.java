 ...
 *
 *   事务状态接口的默认实现类，被用于 事务管理器。基于底层具体的事务对象
 *   该类包含事务管理器的所需的所有状态信息，包括被具体的事务管理器实现类决定的事务对象。
 *   委托提交点相关的方法到实现 SavepointManager 接口的事务对象。
 */
public class DefaultTransactionStatus extends AbstractTransactionStatus {
	...
	private final boolean newTransaction;  // 是否为新的事务

	private final boolean newSynchronization; //  是否为新的同步
	...
	@Nullable
	private final Object suspendedResources; // 被挂起的资源
