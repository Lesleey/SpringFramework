 ...
 *
 *   一个默认的实现类，对于传统的类型转化案例是足够的。为效率方面的考虑会缓存内省结果。
 *   注意： 该类会注册默认的属性编辑器，应用也可以注册自定义的属性编辑器。
 */
public class BeanWrapperImpl extends AbstractNestablePropertyAccessor implements BeanWrapper {
	 ...
	 *
	 *  将被给的值转化为特定属性的类型，该方法仅仅用于在 BeanFactory 的优化， 使用 {@code convertIfNecessary} 方法进行编程类型转化
	 */
	@Nullable
